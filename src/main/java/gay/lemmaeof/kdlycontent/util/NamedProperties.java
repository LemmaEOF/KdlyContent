...
public class NamedProperties {
	...
	static {
		...
		SOUND_GROUPS.put("nether_wood_hanging_sign", BlockSoundGroup.NETHER_WOOD_HANGING_SIGN);
		SOUND_GROUPS.put("bamboo_wood_hanging_sign", BlockSoundGroup.BAMBOO_WOOD_HANGING_SIGN);
		...
		SOUND_GROUPS.put("cherry_wood_hanging_sign", BlockSoundGroup.CHERRY_WOOD_HANGING_SIGN);
		...
		SOUND_GROUPS.put("decorated_pot_shatter", BlockSoundGroup.DECORATED_POT_SHATTER);
		...
		MAP_COLORS.put("diamond", MapColor.DIAMOND_BLUE);
		MAP_COLORS.put("lapis", MapColor.LAPIS_BLUE);
		MAP_COLORS.put("emerald", MapColor.EMERALD_GREEN);
		MAP_COLORS.put("podzol", MapColor.SPRUCE_BROWN);
		MAP_COLORS.put("nether", MapColor.DARK_RED);
